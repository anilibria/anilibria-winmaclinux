...
**Внимание! Для Window 7 перед первым запуском необходимо запустить инсталлятор XAudio (он находится в папке codecpacks и называется DXSETUP.exe)! Его надо установить иначе видеоплеер работать не будет!**
